...
// see read_struct_examples()
SAMPLE build_sample(double * labels, DOC ** instances, int n, STRUCT_LEARN_PARM  * sparm) {
  ...
  PATTERN  *x;
  LABEL    *y;
  long     qid;       /* number of instances */
  long     totpairs, sumtotpairs, i, j, k;
